import { A } from '../../util/Alias'
import { P } from '../../util/Predicate'
import { O } from '../../util/Object'

declare type Mutable<T> = {
  -readonly [P in keyof T]: T[P]
}

declare type FromStrInUnion<U, S extends A.Primitive> = P.Equal<
  Extract<U, `${S}`>,
  never
> extends false
  ? S | Exclude<U, `${S}`>
...
declare type ObjKeyCast<
  K extends A.ObjIndex,
  T extends A.ObjIndex = string
...
declare type OptionRecord<T = A.Primitive> = {
...
declare type ObjKVTypeLiteralMapping<
  O extends { [key: string]: any; [key: number]: any }
> = O.Flip<O>
...
declare type ObjValTypeMap<O extends OptionRecord> =
  ObjValToUnionKey<O> extends infer S1 extends {
    [key: string]: any
    [key: number]: any
  }
